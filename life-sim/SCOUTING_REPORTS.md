# Scouting Reports — Transferziele
## Zuletzt aktualisiert: 1. Juni 2026

> Template für neue Spieler:
> Kopiere den Block unten und fülle ihn aus.
> Status: 🟢 Aktiv verfolgen | 🟡 Beobachten | 🔴 Nicht weiter verfolgen | ✅ Verpflichtet
...
### Marco Senesi — CB — AFC Bournemouth
| Feld | Info |
|------|------|
| Name | Marco Senesi |
| Geb. / Alter | Mai 1997 / 29 |
| Nationalität | 🇦🇷/🇮🇹 Argentinisch-Italienisch |
| Klub | AFC Bournemouth |
| Vertrag bis | 2026 *(läuft aus!)* |
| Marktwert | ~€12M |
| Ablöse (geschätzt) | Free Transfer |
| Wochenlohn (geschätzt) | ~£25-35k |
| Agent | — |
| Status | 🟢 Sofort ansprechen |

**Stärken:** Linksfüßig, PL-erfahren, progressives Aufbauspiel, günstiger Gehalt
**Schwächen:** Kein Top-Niveau-Spieler, Bournemouth ≠ Liverpool-Anspruch
**Fit ins System:** Solide LCB-Backup oder kurzfristige Lösung
**Ethan-Notiz:** Free Transfer. Wenn Budget es nicht zulässt: beste günstige Option. Kein Glamour aber er erledigt den Job.

---

## RECHTSAUSSEN (SALAH-NACHFOLGER)

### Bradley Barcola — RW — Paris Saint-Germain
| Feld | Info |
|------|------|
| Name | Bradley Barcola |
| Geb. / Alter | Sep 2002 / 23 |
| Nationalität | 🇫🇷 Französisch |
| Klub | Paris Saint-Germain |
| Vertrag bis | ~2028 |
| Marktwert | ~€80M |
| Ablöse (geschätzt) | £70-90M |
| Wochenlohn (geschätzt) | ~£150-180k |
| Agent | — |
| Status | 🟡 Beobachten — Budget-abhängig |

**Stärken:** Explosivität, Eins-gegen-Eins, Torgefahr, jung
**Schwächen:** Teuer. PSG gibt ungern ab. Konsistenz noch nicht auf Weltklasse-Niveau
**Fit ins System:** Kann auch links spielen — flexibel einsetzbar
**Ethan-Notiz:** Langzeitziel. Wenn wir in diesem Sommer Budget freisetzen können, ist er die Nummer 1.

---

## MITTELFELD

### Yan Diomande — CM/DM — RB Leipzig
| Feld | Info |
|------|------|
| Name | Yan Diomande |
| Geb. / Alter | ~2002 / ~24 |
...
| Wochenlohn (geschätzt) | ~£70-90k |
| Agent | — |
| Status | 🟢 Hughes hatte Deal angebahnt — prüfen |

**Stärken:** Physisch, Zweikampfstärke, Ballgewinn, modern
**Schwächen:** Noch kein Top-6-PL-Niveau bestätigt
**Fit ins System:** Könnte Endo als Backup-DM ersetzen oder neben Gravenberch spielen
**Ethan-Notiz:** Hughes hatte Liverpool vor PSG in der Pole. Sofort prüfen ob der Stand noch gilt.
...
|------|------|
| Name | Adam Wharton |
| Geb. / Alter | Okt 2003 / 22 |
| Nationalität | 🏴󠁧󠁢󠁥󠁮󠁧󠁿 Englisch |
| Klub | Crystal Palace |
| Vertrag bis | ~2028 |
| Marktwert | ~€30M |
| Ablöse (geschätzt) | £28-35M |
| Wochenlohn (geschätzt) | ~£50-70k |
| Agent | — |
| Status | 🟡 Beobachten — andere Klubs auch interessiert |

**Stärken:** Ruhig am Ball, Spielaufbau, jung und entwicklungsfähig
